...
export default async function Home() {
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-6xl px-6 py-8">
      ...
      <section className="rounded-2xl border border-zinc-800 bg-zinc-950 p-8 shadow-2xl">
        <p className="text-xs uppercase tracking-[0.2em] text-zinc-400">
          Real-time V2V · V2I · GPS
        </p>
        <h1 className="mt-3 text-3xl font-bold text-zinc-100 sm:text-5xl">
          Main Platform Index
        </h1>
        ...
        <div className="mt-8 rounded-xl border border-zinc-700 bg-black p-4 text-sm text-zinc-300">
