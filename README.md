...
- Active runtime (`app/` + `public/`) is TypeScript/JavaScript-first:
  - Active HTML files: `0`
  - Active TS/TSX/JS files: `23`
- Legacy snapshots in `archive/legacy/*` are now stored as `.md` files and are not used by the live Next.js routes.
- Current live module routes are Next.js TypeScript pages.
